...
import { Menu, X, Home, UserCircle, AlertTriangle, UserCheck, LogOut, Menu as MenuIcon } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className={`fixed inset-0 z-40 flex md:hidden ${sidebarOpen ? 'visible' : 'invisible'}`} role="dialog">
        ...
        <div className={`relative flex-1 flex flex-col max-w-xs w-full bg-teal-800 transform transition ${sidebarOpen ? 'translate-x-0 ease-out duration-300' : '-translate-x-full ease-in duration-200'}`}>
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              ...
              <span className="ml-2 text-white font-semibold text-xl">HMS Student</span>
            </div>
            <nav className="mt-5 px-2 space-y-1">
              <NavLink 
                to="/student/dashboard"
                className={({ isActive }) => 
                  `sidebar-link ${isActive ? 'bg-teal-700 text-white' : 'text-teal-200 hover:bg-teal-600 hover:text-white'}`
                }
                onClick={() => setSidebarOpen(false)}
              >
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <button
                  ...
                  className="text-sm font-medium text-teal-200 hover:text-white flex items-center"
                >
